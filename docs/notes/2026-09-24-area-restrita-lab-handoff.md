...
- Alteração do scanner de compatibilidade e checkpoint anterior publicados nos commits `7a259e5670581a0ba94378053f900f20b0c18e7b` e `648b612aa2d6217eb0a35deb9eadcd1f0c749850`; `git ls-remote` confirmou `HEAD=REMOTE` no segundo SHA. O ajuste deste estado mais recente ainda precisa ser commitado/pushado.
