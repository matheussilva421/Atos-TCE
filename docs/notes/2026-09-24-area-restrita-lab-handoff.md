...
- Git antes desta atualização: branch `codex/atos-tce-unified`, HEAD e upstream `ecaf4257cf0a412d99941390f57c2d660a22b87f`, sem alterações versionadas. Commit/push deste adendo ainda pendentes.
