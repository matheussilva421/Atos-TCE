...
- Artefatos raw e sanitized são locais/ignorados: `tmp/portal-lab/2026-09-24-task8-live-scan/`. Nenhum teste executado neste bloco de diagnóstico; nenhum código alterado. A captura não observou a paginação: ela percorreu a árvore de frames, mas não interpretou comandos `javascript:` e a tela de lista não estava carregada.
