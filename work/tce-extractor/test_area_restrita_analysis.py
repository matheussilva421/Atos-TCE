...
class AreaRestritaAnalysisTests(unittest.TestCase):
    ...
    def test_local_artifact_with_failed_or_unknown_evidence_is_not_ready(self):
        from batch_scope import build_preview
        ...
        for evidence_status in ("failed", "unknown"):
            row = {
                "process_key": "1/2023",
                "interested_key": "ana",
                "area_restrita": {
                ...
                "econtas": {
                    ...
                    "documents": [{
                        ...
                        "relative_path": "documentos/doc-1.pdf",
                        "sha256": "e" * 64,
                        "evidence": [{"document_id": "doc-1", "page": 1, "status": evidence_status}],
                    }],
                    "snapshot_hash": "f" * 64,
                    "ocr_status": "ready",
                },
            ...
            self.assertEqual(preview["ocr_ready"], 0, evidence_status)
            self.assertEqual(preview["eligible"], 0, evidence_status)
            self.assertEqual(preview["acquisition_eligible"], 1, evidence_status)
